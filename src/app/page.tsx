...
const PIZZA_EXTRAS = [
  { id: 'huevo', name: 'Huevo duro picado', price: 800 },
  { id: 'queso', name: 'Extra Muzzarella', price: 1200 },
  { id: 'aceitunas', name: 'Aceitunas extras', price: 600 },
  { id: 'roquefort', name: 'Roquefort', price: 1500 },
  { id: 'anchoas', name: 'Anchoas', price: 1500 },
];
...
export default function CatalogPage() {
  ...
  const [selectedExtras, setSelectedExtras] = useState<typeof PIZZA_EXTRAS>([]);
                  ...
                  {Array.from({ length: selectedProductForCart.quadraConfig.customizableRowsCount }).map((_, idx) => (
                    <div key={idx}>
                      ...
                      >
                        ...
                        {selectedProductForCart.quadraConfig!.availableVarieties.map(v => (
